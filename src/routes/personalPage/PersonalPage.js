...
class PersonalPage extends React.PureComponent {
  ...
  defaultMotto = () => <span>{defaultMotto}<IconFont type="question" fontSize="26px" /></span>
      ...
      <div className={style.personalInfos}>
        ...
        <div className={style.infosContainer}>
          ...
          <div className={style.infos}>
            <div className={style.name}>{name}{motto ? <span>{motto}</span> : this.defaultMotto()}</div>
